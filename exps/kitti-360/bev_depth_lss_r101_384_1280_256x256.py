...
class BEVDepthLightningModel(BaseBEVHeightLightningModel):
...
def main(args: Namespace) -> None:
    ...
    if args.evaluate:
        ...
        if os.path.exists("pretrain_ckpt/bevheight_plus_pretrain_car.ckpt"):
            model = BEVDepthLightningModel.load_from_checkpoint("pretrain_ckpt/bevheight_plus_pretrain_car.ckpt")
        '''
        trainer.fit(model)
