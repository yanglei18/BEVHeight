...
return_depth = True
data_root = "/data/THUTraf/THUTraf-V-Raw/"
gt_label_path = "/data/THUTraf/THUTraf-V-Raw/training/label_2"
...
class BEVHeightLightningModel(LightningModule):
    ...
    def __init__(self,
        ...
        self.val_list = [x.strip() for x in open(os.path.join(data_root, "ImageSets",  "train.txt")).readlines()]
    ...
    def train_dataloader(self):
        train_dataset = NuscMVDetDataset(
            ...
            info_path=os.path.join(data_root, 'data_12hz_infos_raw_data.pkl'),
            is_train=True,
...
def main(args: Namespace) -> None:
    ...
    checkpoint_callback = ModelCheckpoint(dirpath='/data/outputs_pretrain/bev_height_lss_r101_864_1536_256x256_v_pretrain/checkpoints', filename='{epoch}', every_n_epochs=5, save_last=True, save_top_k=-1)
    ...
    if args.evaluate:
        ...
        backup_codebase(os.path.join('/data/outputs_pretrain/bev_height_lss_r101_864_1536_256x256_v_pretrain', 'backup'))
...
def run_cli():
    ...
    parser.set_defaults(
        ...
        precision=32,
        default_root_dir='/data/outputs_pretrain/bev_height_lss_r101_864_1536_256x256_v_pretrain')
