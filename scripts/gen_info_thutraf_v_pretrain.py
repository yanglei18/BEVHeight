...
def generate_info_kitti(kitti_root, split='train'):
    ...
    for idx in tqdm(range(len(idx_list))):
        ...
        for cam_name in cam_names:
            ...
            cam_info['height'] = 384
            cam_info['width'] = 1280
            cam_info['filename'] = os.path.join("training", "image_2", index + ".jpg") if split in ["train", "val"] else os.path.join("training", "image_2", index + ".jpg")
...
def main():
    ...
    parser.add_argument("--data_root", type=str,
                        default="/data/THUTraf/THUTraf-V-Raw/",
